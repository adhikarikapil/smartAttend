    ...
    <div className="modal-overlay" onClick={() => setIsJoinModalOpen(false)}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <h2>Join Class</h2>
          <button className="close-button" onClick={() => setIsJoinModalOpen(false)}>
        ...
        <form onSubmit={handleJoinSubmit} className="create-class-form">
          <div className="form-group">
            ...
            />
            <span className="code-hint">Enter the 6-character code provided by your teacher</span>
          </div>
          <div className="form-actions">
            <button type="button" className="cancel-btn" onClick={() => setIsJoinModalOpen(false)}>
              Cancel
            </button>
  ...
  const TeacherClasses = () => (
    <div className="classes-content">
      <div className="classes-header">
        <h1>My Classes</h1>
        <button className="create-class-btn" onClick={() => setIsCreateModalOpen(true)}>
    ...
    <div className="classes-content">
      <div className="classes-header">
        ...
        <div className="student-header-actions">
          ...
          <button className="join-class-btn" onClick={() => setIsJoinModalOpen(true)}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="add-icon">
          ...
          <div key={index} className="class-card">
            ...
            <div className="class-card-footer">
              ...
              <button 
                ...
                onClick={() => handleLeaveClass({ id: index, name: `Mathematics ${index + 1}` })}
              >
                Leave Class
              </button>
            </div>
  ...
  const LeaveClassModal = () => (
    <div className="modal-overlay" onClick={() => setIsLeaveModalOpen(false)}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <h2>Leave Class</h2>
          <button className="close-button" onClick={() => setIsLeaveModalOpen(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            </svg>
          </button>
        ...
        <div className="leave-class-content">
          <div className="warning-message">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="warning-icon">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <p>Are you sure you want to leave <strong>{selectedClass?.name}</strong>?</p>
            <p className="warning-details">This action cannot be undone. You'll need a new class code to rejoin.</p>
          </div>
          <div className="form-actions">
            <button type="button" className="cancel-btn" onClick={() => setIsLeaveModalOpen(false)}>
              Cancel
            </button>
            <button type="button" className="leave-btn" onClick={confirmLeaveClass}>
              Leave Class
            </button>
          </div>
        </div>
